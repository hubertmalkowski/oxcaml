...
2 | type 'a t1 = Mk1 of 'a @@ global forkable
                                     ^^^^^^^^
Warning 219 [redundant-modality]: This forkable modality is redundant.
...
9 | type 'a t8 = Mk8 of 'a @@ forkable yielding
                                       ^^^^^^^^
Warning 219 [redundant-modality]: This yielding modality is redundant.

type 'a t8 = Mk8 of 'a @@ forkable
Line 10, characters 26-36:
10 | type 'a t9 = Mk9 of 'a @@ unforkable unyielding
                               ^^^^^^^^^^
Warning 219 [redundant-modality]: This unforkable modality is redundant.
