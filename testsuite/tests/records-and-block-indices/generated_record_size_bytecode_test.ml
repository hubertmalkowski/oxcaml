...
type t23 = { mutable a23 : float; mutable b23 : float# } [@@flatten_floats] (* { float; float# } *)
...
type t49 = { mutable a49 : t45; mutable b49 : float# } [@@flatten_floats] (* { #{ float }; float# } *)
type t50 = { mutable a50 : t28; mutable b50 : float } (* { #{ float; float }; float } *)
type t51 = #{ a51 : float# } (* #{ float# } *)
type t52 = { mutable a52 : t51; mutable b52 : float } [@@flatten_floats] (* { #{ float# }; float } *)
